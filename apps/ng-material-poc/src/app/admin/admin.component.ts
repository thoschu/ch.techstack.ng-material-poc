...
export class AdminComponent implements OnInit, OnDestroy {
    ...
    this.adminService
      ...
      .pipe(
        tap((admin: Admin<number>): void => {
          ...
          const adminAction: Record<'admin', Admin<number>> &
            TypedAction<'[Admin Page] SetAdmin Action'> =
            setAdminActionCreator(props);
          ...
          const setAdminAction: {
            ...
            adminActions.setAdminAction({ admin });
  ...
  ngOnDestroy(): void {
    const deleteAdminAction: TypedAction<'[Admin Page] DeleteAdmin Action'> =
      adminActions.deleteAdminAction();
