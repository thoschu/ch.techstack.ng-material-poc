...
export const mamaFeatureSelector: MemoizedSelector<
  object,
  MamaState,
  DefaultProjectorFn<MamaState>
> = createFeatureSelector<MamaState>('mama');
export const adminFeatureSelector: MemoizedSelector<
  object,
  AdminState,
...
export const userSelector: MemoizedSelector<
  State,
  string,
  (s1: MamaState, s2: AdminState) => string
> = createSelector(
  mamaFeatureSelector,
