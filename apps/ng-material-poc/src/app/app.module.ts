...
export class RollbarErrorHandler implements ErrorHandler {
  public static readonly ROLLBAR_CONFIG: {
    accessToken: string;
...
export const RollbarService: InjectionToken<Rollbar> =
  new InjectionToken<Rollbar>('rollbar');

@NgModule({
  declarations: [AppComponent, UserComponent, MamaComponent],
  imports: [
    BrowserModule,
    ...
    StoreModule.forFeature(fromMama.mamaFeatureKey, fromMama.reducers, {
      metaReducers: fromMama.metaReducers,
    }),
  ...
  providers: [
    ...
    provide: ErrorHandler, useClass: RollbarErrorHandler
      ...
      useFactory: RollbarErrorHandler.ROLLBAR_FACTORY,
    },
    UserGuard,
  ],
...
export class AppModule {
  ...
  private static appInitializerUsingPromises(
    ...
    return () =>
      new Promise((resolve, reject): void => {
        httpClient
          .get<Users>(AppModule.URL.href)
          .pipe(
            tap((result: Users): void => {
              console.log(result);

              const loadAppsAction: TypedAction<'[App] Load Apps'> =
                appActions.loadApps();
          ...
          .subscribe(
            (res: Users): void => {
              ...
              const loadAppsConfigAction: {
                app: string | Record<'id' | 'name', string | number>[];
